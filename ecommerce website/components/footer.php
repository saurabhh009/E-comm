<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:sks@gmail.com"><i class="fas fa-envelope"></i> sks@gmail.com</a>
         <a href=""><i class="fas fa-map-marker-alt"></i> Muzaffarpur, india - 842004 </a>
      </div>
   ...
   <div class="credit">&copy; Copyright @ <?= date('Y'); ?> by <span>Saurabh</span> | All rights reserved!</div>
